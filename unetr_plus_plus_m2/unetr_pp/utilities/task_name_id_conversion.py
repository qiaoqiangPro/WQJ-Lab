...
def convert_id_to_task_name(task_id: int):
    print(nnFormer_raw_data, preprocessing_output_dir, nnFormer_cropped_data, network_training_output_dir)
    ...
    if preprocessing_output_dir is not None:
        ...
        print(' candidates_preprocessed:', candidates_preprocessed)
    else:
